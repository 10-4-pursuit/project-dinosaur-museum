...
function getLongestDinosaur(dinosaurs) {
  ...
  return { [longestDinosaur.name]: longestDinosaur.lengthInMeters * 3.28084 }; // Convert length to feet and return as an object.
}
...
function getDinosaurDescription(dinosaurs, id) {
  ...
  let periodText = dinosaur.period;
  if (dinosaur.mya.length > 0) {
    periodText += `, over ${dinosaur.mya.join(' and ')} million years ago`;
  }
